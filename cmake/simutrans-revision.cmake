...
if (Subversion_FOUND OR Git_FOUND)
	option(SIMUTRANS_WITH_REVISION "Build executable with SVN revision information" ON)
...
if (SIMUTRANS_WITH_REVISION)
	...
	if (SIMUTRANS_WC_REVISION)
		...
		target_compile_definitions(simutrans PRIVATE REV=${SIMUTRANS_WC_REVISION})
	else ()
		message(WARNING "Could not find revision information because this repository "
			...
			"will be unavailable.")
		target_compile_definitions(simutrans PRIVATE REV="")
	endif ()
endif (SIMUTRANS_WITH_REVISION)
